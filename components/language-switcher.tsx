...
const btnClass =
  "inline-flex min-h-[44px] min-w-[44px] items-center justify-center gap-1.5 rounded-md border border-accent/25 px-2 py-1.5 text-sm font-medium text-ink transition hover:border-accent/50 hover:bg-accent/10 sm:min-h-0 sm:min-w-0 sm:px-2.5 sm:py-1.5";
...
export async function LanguageSwitcher() {
  ...
  return (
    <div
      className="flex items-center gap-1 rounded-lg border border-accent/20 bg-surface-card/80 p-0.5"
      role="group"
